...
export default function SearchBar({ allLabels, allMembers, filterLabel, filterMember, filterDue, onFilterLabel, onFilterMember, onFilterDue }) {
  ...
  const hasFilter = filterLabel || filterMember || filterDue;

  const clearAll = () => { onFilterLabel(null); onFilterMember(null); onFilterDue(null); };
